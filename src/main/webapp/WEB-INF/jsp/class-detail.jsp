<%@page import="com.google.gson.JsonObject" %>
 ...
 -->
					...
					<% JsonParser parser=new JsonParser();
						System.out.println(request.getAttribute("classdetailproperties")); // JsonElement
						element=parser.parse(String.valueOf(request.getAttribute("classdetailproperties"))); // String
						recommend_num=element.getAsJsonObject().get("recommend_num").getAsString(); // String
						recommend_score=element.getAsJsonObject().get("recommend_score").getAsString(); // JsonArray
						jarr=new JsonArray(); // jarr.add(element.getAsJsonObject().getAsJsonArray("reviewlist")); //
						String
						classname=element.getAsJsonObject().get("classdetailJson").getAsJsonObject().get("classname").getAsString();
						// String
						creatername=element.getAsJsonObject().get("classdetailJson").getAsJsonObject().get("creatername").getAsString();
						// String
						introduce=element.getAsJsonObject().get("classdetailJson").getAsJsonObject().get("introduce").getAsString();
						// String
						period=element.getAsJsonObject().get("classdetailJson").getAsJsonObject().get("period").getAsString();
						// String
						content_num=element.getAsJsonObject().get("classdetailJson").getAsJsonObject().get("content_num").getAsString();
						// String
						detail=element.getAsJsonObject().get("classdetailJson").getAsJsonObject().get("detail").getAsString();
						// String
						chapter=element.getAsJsonObject().get("classdetailJson").getAsJsonObject().get("chapter").getAsString();
						// String
						creater_info=element.getAsJsonObject().get("classdetailJson").getAsJsonObject().get("creater_info").getAsString();
						// String
						address=element.getAsJsonObject().get("classdetailJson").getAsJsonObject().get("address").getAsString();
						%>
														...
														<section class="PostViewCintroller">
															...
															<div class="PostReviewCardList">
																<h2>이런 걸 배울거에요.😊h2>
																	...
																	<a class="LinkBlock">
																		<div class="lastMore">
																			<span class="RatioImages_Container">
																				<img>
																			</span>
																		</div>
																	</a>
